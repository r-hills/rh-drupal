  ...
  <div id="main" class="clearfix">
    <div id="primary">
      <section id="content" role="main">
        ...
        $slide4_url = check_plain(theme_get_setting('slide4_url','responsive_blog'));
        ...
        $slide4_desc = check_markup(theme_get_setting('slide4_desc', 'responsive_blog'), 'full_html');
        ?>
        <div id="slider">
          <div id="slider-wrap">
            ...
            <div class="slides displaynone">
              <a href="<?php print url($slide4_url); ?>"><img width="644" height="320" src="<?php print base_path() . drupal_get_path('theme', 'responsive_blog') . '/images/slide-image-4.jpg'; ?>" class="pngfix"/></a>
